...
| Evolver | Diagnostic sample IDs and per-sample predictions, source release | Full-test mean includes samples used for diagnostic feedback; DataFlow's expert-authored Math-3K is stronger; public source release in preparation |
